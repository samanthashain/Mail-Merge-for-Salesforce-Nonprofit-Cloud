The goal of this solution is to provide a single button that produces a downloadable file with standard address mailing labels for households that meet certain criteria included in the embedded query.
